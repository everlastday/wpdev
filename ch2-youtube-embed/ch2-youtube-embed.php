<?php
  ...
  */
    ...
    <div id="ch2ye-general" class="wrap">
      ...
      <form name="ch2ye_options_form" method="post" action="admin-post.php">
        ...
        <table>
          ...
          <tr>
            <td>Video Width</td>
            <td><input type="text" name="width" value="<?php echo esc_html( $options[ 'width' ] ); ?>" /></td>
          </tr>
          <tr>
            <td>Video Height</td>
            <td><input type="text" name="height" value="<?php echo esc_html( $options[ 'height' ] ); ?>" /></td>
          </tr>
          <tr>
  ...
  // Check that user has proper security level
    ...
    // Cycle through all check box form fields and set options array to true or false values
