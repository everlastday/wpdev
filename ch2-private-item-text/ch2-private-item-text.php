  ...
  function ch2pit_config_page () {
    ...
    <div id="ch2pit-general" class="wrap">
      ...
      <form name="ch2pit_options_form" method="post" action="admin-post.php">
        ...
        Stylesheet<br />
        <textarea name="stylesheet" rows="10" cols="40" style="fontfamily:Consolas,Monaco,monospace"><?php echo esc_html( $options[ 'stylesheet' ] ); ?></textarea> <br />
        <input type="submit" value="Submit" class="button-primary" /> <input type="submit" value="Reset" name="resetstyle" class="button-primary" />
      </form>
    </div>
  <?php
  }
